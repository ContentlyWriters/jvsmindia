...
<section className="relative py-28 px-6 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-950 text-white overflow-hidden">
...
.map((item, i) => {
  const Icon = item.icon;   // ⭐ YE LINE MISSING THI
